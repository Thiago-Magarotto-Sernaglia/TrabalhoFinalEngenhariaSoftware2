...
async def test_produto_repository_create(db_connection):
    ...
    produto = ProdutoIn(nome="Produto Teste", preco=10.0, unidade="un", categoria_id=cat_id, estoque=5)
...
async def test_produto_repository_list_all(db_connection):
    ...
    await prod_repo.create(ProdutoIn(nome="Produto 1", preco=10.0, unidade="un", categoria_id=cat_id))
    await prod_repo.create(ProdutoIn(nome="Produto 2", preco=20.0, unidade="un", categoria_id=cat_id))
...
async def test_produto_repository_get_by_id(db_connection):
    ...
    prod_id = await prod_repo.create(ProdutoIn(nome="Produto Get", preco=15.0, unidade="un", categoria_id=cat_id))
...
async def test_produto_repository_delete(db_connection):
    ...
    prod_id = await prod_repo.create(ProdutoIn(nome="Produto Delete", preco=10.0, unidade="un", categoria_id=cat_id))
...
async def test_produto_repository_update(db_connection):
    ...
    prod_id = await prod_repo.create(ProdutoIn(nome="Produto Original", preco=10.0, unidade="un", categoria_id=cat_id, estoque=5))
